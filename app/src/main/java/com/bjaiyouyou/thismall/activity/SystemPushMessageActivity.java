...
import com.bjaiyouyou.thismall.adapter.SystemPushMessageAdapter;
...
//                mPushMessageData.addAll(dataBeanList);
     ...
     * 本地广播处理系统消息接收时更新数据
     */
    public static String MESSAGE_RECEIVER_ACTION="com.bjaiyouyou.thismall.intent.ACTION_JPUSH_MESSAGE_RECEIVE_SYSTEM";
