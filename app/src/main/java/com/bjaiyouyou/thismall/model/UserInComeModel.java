...
public class UserInComeModel {
    ...
    public static class MemberBean {
        private long id;
        private long invitation_member_id;
        ...
        private double can_drawings_amount;
        private int is_vip;
        ...
        public long getInvitation_member_id() {
            return invitation_member_id;
        }

        public void setInvitation_member_id(long invitation_member_id) {
        ...
        public double getCan_drawings_amount() {
            return can_drawings_amount;
        }

        public void setCan_drawings_amount(double can_drawings_amount) {
