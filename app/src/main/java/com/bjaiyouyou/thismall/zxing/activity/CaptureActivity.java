package com.bjaiyouyou.thismall.zxing.activity;
...
import com.bjaiyouyou.thismall.zxing.decoding.InactivityTimer;
...
import static com.bjaiyouyou.thismall.utils.LogUtils.e;
...
//								Looper.loop();
//							} else {
//								Log.e("123result", result.toString());
...
//			e.printStackTrace();
//		}
//		Toast.makeText(getApplicationContext(),"解析扫描结果为空",Toast.LENGTH_SHORT).show();
//		return null;
//	}
