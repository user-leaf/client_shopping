...
public class PayUtils {
    ...
    public static void payAlert(final Context context, final boolean isActivity, final Activity activity, final Fragment fragment, final String orderNum, final View clickView, final String clazzName) {
        ...
        String strAlipay = "支付宝支付";
        payWayNames.add(strAlipay);
        payWayMap.put(strAlipay, Constants.CHANNEL_ALIPAY);
        String strWechat = "微信支付";
        payWayNames.add(strWechat);
        payWayMap.put(strWechat, Constants.CHANNEL_WECHAT);
