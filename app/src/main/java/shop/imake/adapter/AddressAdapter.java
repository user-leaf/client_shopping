...
import shop.imake.R;
import shop.imake.activity.AddressAddActivity;
import shop.imake.activity.AddressManagerActivity;
import shop.imake.activity.OrderMakeActivity;
 ...
 * @date 2016/6/12
 */
public class AddressAdapter extends BaseSwipeAdapter implements View.OnClickListener {
    ...
    public AddressAdapter(Context context, List<AddressInfo2.MemberAddressesBean> list, String pageName) {
        mContext = context;
        mList = list;
                ...
                if (OrderMakeActivity.TAG.equals(pageName)) {
                    if (tag != null && tag instanceof Integer) {
                        ...
                        if (memberAddressesBean != null) {
                            ...
                            ((AddressManagerActivity)mContext).setResult(Activity.RESULT_OK, intent);
...
//                        ToastUtils.showShort("编辑");
    ...
    private void doDelete(View v) {
        ...
        if (tag != null && tag instanceof Integer) {
            ...
            LogUtils.d("AddressAdapter", "delete url= " + url);
